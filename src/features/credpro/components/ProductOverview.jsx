      ...
      <div className="product-overview-container">
        ...
        <div className="product-overview-content">
          ...
          <p className="product-overview-description">
            CredPro is AadiSwan's flagship digital lending automation platform, designed to streamline the entire credit lifecycle — from origination and underwriting to sanctioning, disbursement, and monitoring. Built on policy-driven workflows and 100+ API integrations, it empowers banks, NBFCs, and MSME lenders to achieve faster turnaround times, stronger compliance, and smarter decision-making.
          </p>
          ...
          <div className="target-audience-section">
            ...
            <ul className="audience-list">
              <li>Banks seeking scalable lending automation</li>
              <li>NBFCs & Cooperatives requiring faster sanctioning</li>
              <li>MSME Lenders needing efficient origination & monitoring</li>
            </ul>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">End-to-End Credit Automation</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">AI-powered monitoring & compliance</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Seamless API integration ecosystem</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Faster, error-free decision-making</span>
            </div>
          </div>
        </div>
