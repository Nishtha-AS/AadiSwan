      ...
      <div className="product-overview-container">
        ...
        <div className="product-overview-content">
          ...
          <p className="product-overview-description">
            CADPro is AadiSwan’s purpose-built credit administration platform that streamlines everything post-sanction to post-disbursement—including document templatization, covenant scheduling & tracking, disbursement workflows, collateral & limit management, and ongoing compliance. With policy-driven workflows and 100+ API integrations, CADPro gives operations teams a single, controlled system of record that improves turnaround times, auditability, and customer transparency.
          </p>
          ...
          <div className="target-audience-section">
            ...
            <ul className="audience-list">
              <li>Banks looking to industrialize credit administration and servicing</li>
              <li>NBFCs & Co-operatives needing consistent, compliant disbursements</li>
              <li>Lenders seeking automated covenant monitoring & documentation control</li>
            </ul>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">Faster, Error-Free Disbursement Decisions</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">End-to-End Credit Administration</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Automated Document & Template Engine</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Covenant & Compliance Tracking</span>
            </div>
          </div>
        </div>
