      ...
      <div className="product-overview-container">
        ...
        <div className="product-overview-content">
          ...
          <p className="product-overview-description">
            CAMPro is AadiSwan’s intelligent Credit Appraisal Memo automation platform, designed to transform the appraisal and assessment process for banks, NBFCs, and financial institutions. By combining AI-powered analysis, sentiment interpretation, and industry benchmarking, CAMPro enables institutions to prepare precise, data-backed appraisal reports in a fraction of the time. With deep financial modeling, automated ratio analysis, and integration with live industry data, CAMPro empowers credit teams to make consistent, transparent, and informed lending decisions — enhancing risk visibility and strengthening portfolio quality across sectors.
          </p>
          ...
          <div className="target-audience-section">
            ...
            <ul className="audience-list">
              <li>Banks looking to digitize and accelerate their credit appraisal process</li>
              <li>NBFCs & financial institutions seeking data-driven, consistent memo generation</li>
              <li>MSME lenders wanting faster, AI-assisted risk evaluation and decision-making</li>
            </ul>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">AI-led Credit Appraisal Automation</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Integrated Financial & Industry Benchmarking</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Sentiment & Risk Analysis Engine</span>
            </div>
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Faster, Consistent, and Transparent Credit Decisions</span>
            </div>
          </div>
        </div>
