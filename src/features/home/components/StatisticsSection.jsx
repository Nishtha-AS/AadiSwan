            ...
            return (
              <article key={i} className="stat-card">
                ...
                <header className="stat-top">
                  {s.icon === "lock" && (
                    <svg className="stat-icon" viewBox="0 0 24 24" width="28" height="28">
                      <path d="M6 10V8a6 6 0 1 1 12 0v2" stroke="#1C5682" strokeWidth="2" fill="none" strokeLinecap="round" />
                      <rect x="4" y="10" width="16" height="10" rx="2" stroke="#1C5682" strokeWidth="2" fill="none" />
                    </svg>
                  )}
